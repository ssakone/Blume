...
Item {
    ...
    function selectDevice(index, type) {
        ...
        if (deviceManager.getDeviceByProxyIndex(index, type).selected)
            return
    ...
    Flickable {
        ...
        Column {
            ...
            SectionTitle {
                ...
                text: qsTr("Plant sensor(s)", "",
                           deviceManager.devicePlantCount)
            ...
            SectionTitle {
                ...
                text: qsTr("Thermometer(s)", "",
                           deviceManager.deviceThermoCount)
            ...
            SectionTitle {
                ...
                text: qsTr("Environmental sensor(s)", "",
                           deviceManager.deviceEnvCount)
