...
BPage {
    ...
    onCurrentPlantChanged: {
        ...
        if (currentPlant.sunlight) {
            ...
            sunlight4.color = currentPlant.sunlight.includes(
                        "full sun") ? Theme.colorYellow : Qt.lighter(
                                          Theme.colorYellow, 1.8)
            sunlight3.color = currentPlant.sunlight.includes(
                        "part sun") ? Qt.lighter(Theme.colorYellow,
                                                 1.25) : Qt.lighter(
                                          Theme.colorYellow, 1.8)
            sunlight2.color = currentPlant.sunlight.includes(
                        "part shade") ? Qt.lighter(Theme.colorYellow,
                                                   1.45) : Qt.lighter(
                                            Theme.colorYellow, 1.85)
            sunlight1.color = currentPlant.sunlight.includes("shade to")
                    || currentPlant.sunlight.includes(
                        "to shade") ? Qt.lighter(Theme.colorYellow,
                                                 1.55) : Qt.lighter(
                                          Theme.colorYellow, 1.9)
        ...
        if (currentPlant.watering) {
            ...
            var watStr = ""
            if (watwat == 1)
                watStr = qsTr("low water needs") + "<br>"
            else if (watwat == 2)
                watStr = qsTr("medium water needs") + "<br>"
            else if (watwat == 3)
                watStr = qsTr("high water needs") + "<br>"
            else if (watwat == 4)
                watStr = qsTr("keep moist") + "<br>"
            if (currentPlant.watering.includes("dry"))
                watStr += qsTr("water when soil is dry")
            if (currentPlant.watering.includes("spay"))
                watStr += qsTr("spray water on leaves")
        ...
        // limit sliders
        rangeSlider_soilMoist.setValues(currentPlant.soilMoist_min,
                                        currentPlant.soilMoist_max)
        rangeSlider_soilCondu.setValues(currentPlant.soilCondu_min,
                                        currentPlant.soilCondu_max)
        itemSoilPH.visible = (currentPlant.soilPH_min > 0)
        rangeSlider_soilPH.setValues(currentPlant.soilPH_min,
                                     currentPlant.soilPH_max)
        rangeSlider_temp.setValues(currentPlant.envTemp_min,
                                   currentPlant.envTemp_max)
        rangeSlider_humi.setValues(currentPlant.envHumi_min,
                                   currentPlant.envHumi_max)
        rangeSlider_lumi_lux.setValues(currentPlant.lightLux_min,
                                       currentPlant.lightLux_max)

        itemLumiMmol.visible = (currentPlant.lightMmol_min > 0)
        rangeSlider_lumi_mmol.setValues(currentPlant.lightMmol_min,
                                        Math.max(currentPlant.lightMmol_min,
                                                 currentPlant.lightMmol_max))
    }

    Flickable {
        anchors.fill: parent
        contentHeight: plantScreen.height
        Grid {
            id: plantScreen
            width: parent.width
        ...
        */
                    ...
                    RowLayout {
                        ...
                        ButtonWireframeIcon {
                            ...
                            onClicked: screenPlantBrowser.loadScreenFrom(
                                           "DevicePlantSensor")
                        }
                        ButtonWireframeIcon {
                            fullColor: true
                    ...
                    Flow {
                        ...
                        Repeater {
                            ...
                            ItemTag {
                                text: UtilsPlantDatabase.getPlantTagText(
                                          modelData)
                                textColor: "white"
                                textSize: Theme.fontSizeContentSmall
                                color: UtilsPlantDatabase.getPlantTagColor(
                                           modelData)
                            }
                        }
                    }
                        ...
                        Row {
                            ...
                            ButtonWireframeIcon {
                                ...
                                onClicked: Qt.openUrlExternally(
                                               ...
                                               + currentPlant.nameBotanical_url)
                            }
                            ...
                            ButtonWireframeIcon {
                                ...
                                onClicked: Qt.openUrlExternally(
                                               "https://www.rhs.org.uk/plants/search-results?query="
                                               + currentPlant.nameBotanical)
                            }
                        }
                    }
                    ...
                    Item {
                        ...
                        RangeSliderValueSolid {
                            ...
                            Row {
                                ...
                                spacing: 3
                                property int phsz: (rangeSlider_soilPH.width - 2
                                                    * rangeSlider_soilPH.padding
                                                    - 4 - 5 * spacing) / 6
                    ...
                    Item {
                        ...
                        RangeSliderValueSolid {
                            ...
                            Row {
                                ...
                                width: rangeSlider_lumi_lux.width - 2
                                       * rangeSlider_lumi_lux.padding - 4
                                spacing: 3
